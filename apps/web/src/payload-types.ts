...
export interface Item {
  ...
  type: 'weapon' | 'armor' | 'consumable' | 'tool' | 'pack' | 'ration' | 'loot';
  weapon?: {
    weaponType?: ('melee' | 'ranged') | null;
    ...
    modifiers?:
      | {
          modifier?: {
            modifierType?:
              | ('ability' | 'attribute' | 'initiative' | 'speed' | 'armorClass' | 'health' | 'effect')
              | null;
            effects?:
              | {
                  effect?: {
                    effectType?: ('grant' | 'revoke' | 'condition') | null;
                  };
                  id?: string | null;
                }[]
              | null;
    ...
    modifiers?:
      | {
          modifier?: {
            ...
            speed?:
              | ('climbing' | 'crawling' | 'flying' | 'jumping' | 'running' | 'swimming' | 'tunneling' | 'walking')
              | null;
            adjustmentType?: ('fixed' | 'increment') | null;
